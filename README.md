...
1 Change current directory to Dookan

    Run - & {PAth to Python.exe} {Path to Dookan Folder}/app.py 
    You will see flask app running on http://127.0.0.1:5000/

2 Change current directory to Dookan/aman

    Run npm start
    You will see react app running on http://localhost:3000/

3 To Check MongoDB connection on http://127.0.0.1:5000/test_mongo

4 To Check API logs on http://127.0.0.1:5000/api/logs

5 You can start browsing on react app running on http://localhost:3000/
